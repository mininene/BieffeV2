    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
...

            {
                ...
                //                     new Maestro{Id = 1, Matricula = "NF8387A", Nombre = "AutoA",Version = 4401, IP = "10.109.80.81",  Seccion = "SabiUno", Estado=true, UltimoCiclo= "02504", RutaSalida= @"C:\Users\fuenteI3\Desktop\API\AutoClaveA\"},
                ...
                //{
                    ...
                    if (lhandle == 0)
                    {
                        using (var db = new CicloAutoclave()) //entidad de data entity
                    ...
                    {
                        case 0:
                            Console.WriteLine("Archivo recibido con exito" + " " + lasterror);
                            break;
                        case 21:
                            Console.WriteLine("El Equipo no esta preparado" + " " + lasterror);
                            break;
                        case 5:
                            Console.WriteLine("Acceso Denegado" + " " + lasterror);
                            break;
                        case 32899128:
                            Console.WriteLine("Ya existe una conexion abierta" + " " + lasterror);
                            break;
                        case 32899137:
                            Console.WriteLine("Estado de conexion no permitido" + " " + lasterror);
                            break;
                        case 32899138:
                            Console.WriteLine("El ID o IP son invalidos" + " " + lasterror);
                            break;
                        case 3670019:
                            Console.WriteLine("No ha sido Encontrado el archivo" + "  " + lasterror);
                            break;          
