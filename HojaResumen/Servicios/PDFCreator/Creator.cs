                ...
                foreach (var t in ListaAutoclaves)
                {
                    foreach (var n in context.MaestroAutoclave)
                    {
                        ...
                        try
                        {
                            ...
                            var q = (from x in context.CiclosAutoclaves.Where(x => x.IdAutoclave == t.Autoclave && x.NumeroCiclo==num)
                            ...
                            if (n.Estado == true)
                            {
                               ...
                               if(programaInt==8 || programaInt==20)
                                {
                                    ...
                                    graph.DrawString("Por: Automático ", font, XBrushes.Black, new XRect(440, 15, pdfPage.Width.Point, pdfPage.Height.Point), XStringFormats.TopLeft);
                                    ...
                                    else
                                    {
                                        ...
                                        if (error.Count() > 24)
                                        {
                                            ...
                                            graph2.DrawString("Por: Automático ", font, XBrushes.Black, new XRect(440, 15, pdfPage.Width.Point, pdfPage.Height.Point), XStringFormats.TopLeft);
                                            graph.DrawString("ALARMAS:", fontDos, XBrushes.Black, new XRect(340, 525, pdfPage.Width.Point, pdfPage.Height.Point), XStringFormats.TopLeft);
